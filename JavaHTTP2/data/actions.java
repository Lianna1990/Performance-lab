...
;
	...
	_webresult = lrapi.web.image("ux-logo-new-white.svg", new String[]{ 
	...
	_webresult = lrapi.web.url("xd_arbiter.php", 
		"URL=https://staticxx.facebook.com/connect/xd_arbiter.php?version=44", new String[]{ 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://test.uxcrowd.ru/", 
		"Snapshot=t8.inf", 
...
;
	...
	_webresult = lrapi.web.custom_request("ping", 
...
;
	...
	_webresult = lrapi.web.url("5-SayzK6NzoFS4_XM_MwWUSdBKJtIeBEy9kKuVgjw5Dpl9ZLFHJQ7IOgpgA6ByavfJCO19yWo8Fw6n1PnPu-OzCtYxMIm1oTnEjRn4", 
		"URL=https://nexus-websocket-a.intercom.io/pubsub/5-SayzK6NzoFS4_XM_MwWUSdBKJtIeBEy9kKuVgjw5Dpl9ZLFHJQ7IOgpgA6ByavfJCO19yWo8Fw6n1PnPu-OzCtYxMIm1oTnEjRn4?X-Nexus-New-Client=true&X-Nexus-Version=0.4.67&user_role=visitor", new String[]{ 
		"Resource=0", 
		"Referer=", 
		"Snapshot=t10.inf", 
		"Mode=HTML", 
