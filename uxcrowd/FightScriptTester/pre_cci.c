# 1 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c"
...
# 1 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2
...
# 2 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2
...
# 3 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2
...
# 4 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2

# 1 "UC01_tester_registration.c" 1
UC01_tester_registration()
{
	...
	lr_end_transaction("UC01_tester_registration",2);
	
	return 0;
}
# 5 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2
...
# 6 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2

# 1 "UC02_fill_tester_profile.c" 1
char * generate(){
...
UC02_fill_tester_profile()
{
	...
	lr_save_datetime("%d.%m.%Y", 0 - 86400*366*age, "birthday"); 
	...
	lr_end_transaction("fill_profile",2);

	return 0;
}
# 7 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2

# 1 "UC03_list_of_tests_tester.c" 1
UC03_list_of_tests_tester()
{
	...
	if (atoi(lr_eval_string("{age}"))==20){
		...
		lr_end_transaction("UC03_list_of_tests_tester (50 tests)", 2);
	} else {
		
		lr_end_transaction("UC03_list_of_tests_tester (100 tests)", 2);
	}
	
	return 0;
}
# 8 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2

# 1 "UC04_passing_user_tests.c" 1
...
{	
	...
	if (randVideo < 3) {
		lr_end_transaction("upload_small_video", 2);
	} else if (randVideo < 9) {
		lr_end_transaction("upload_medium_video", 2);
	} else {
		lr_end_transaction("upload_big_video", 2);
	}
	...
	lr_end_transaction("UC04_passing_user_tests", 2);
	
	return 0;
}
# 9 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2
...
# 10 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2
...
# 11 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2
...
# 12 "d:\\users\\user\\desktop\\dmitriz\\uxcrowd\\fightscripttester\\\\combined_FightScriptTester.c" 2
